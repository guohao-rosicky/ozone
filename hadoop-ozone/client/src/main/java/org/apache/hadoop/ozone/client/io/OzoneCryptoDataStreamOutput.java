...
/**
 * CryptoDataStreamOutput encrypts data. It is not thread-safe. AES CTR mode is
 ...
 */
public class OzoneCryptoDataStreamOutput implements ByteBufferStreamOutput {

  private final ByteBufferStreamOutput out;
  ...
  public OzoneCryptoDataStreamOutput(ByteBufferStreamOutput out,
                                     CryptoCodec codec,
  ...
  public OzoneCryptoDataStreamOutput(ByteBufferStreamOutput out,
    ...
    this(out, codec, CryptoStreamUtils.getBufferSize(codec.getConf()), key, iv,
        0, true);
  }

  public ByteBufferStreamOutput getWrappedStream() {
    return out;
  }
